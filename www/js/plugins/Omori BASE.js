...
ConfigManager.applyData = function(config) {
  // WEB SAFETY: config may be undefined in browser
  config = config || {};

// DO NOT call original applyData in web builds
// It assumes NW.js + config.rpgsave and will crash
  ...
  // Set Input Maps
Input.keyMapper = config.keyboardInputMap || Input.keyMapper;
Input.gamepadMapper = config.gamepadInputMap || Input.gamepadMapper;
...
ConfigManager.restoreDefaultConfig = function() {
  alert("Dumbass goofy ass nigga tryna use restore config in a web build.");
};
